...
export default function HomePage() {
  const [currentView, setCurrentView] = useState<'home' | 'check-position' | 'roster'>('home');
  ...
  return (
    <div className="relative min-h-screen w-full bg-black text-white font-sans selection:bg-white selection:text-black flex flex-col justify-between p-6 sm:p-10 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <img
          src="/horizontal-lander.png"
          alt=""
          className="hidden sm:block absolute inset-0 h-full w-full object-contain object-center opacity-35"
        />
        <img
          src="/vertical-lander.png"
          alt=""
          className="block sm:hidden absolute inset-0 h-full w-full object-cover object-center opacity-35"
        />
